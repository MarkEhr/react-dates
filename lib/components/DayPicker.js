...
function (_ref) {
  ...
  DayPicker.getDerivedStateFromProps = function getDerivedStateFromProps(props, state) {
    var hidden = props.hidden,
        isFocused = props.isFocused,
        showKeyboardShortcuts = props.showKeyboardShortcuts,
        onBlur = props.onBlur,
        renderMonthText = props.renderMonthText,
    ...
    newState.calendarMonthWidth = (0, _getCalendarMonthWidth["default"])(props.daySize, horizontalMonthPadding);
  ...
  _proto.getSnapshotBeforeUpdate = function getSnapshotBeforeUpdate(prevProps, prevState) {
    ...
    if (orientation === _constants.VERTICAL_SCROLLABLE && this.transitionContainer && !(0, _isSameMonth["default"])(currentMonth, prevState.nextCurrentMonth)) {
      this.currentMonthScrollTop = this.transitionContainer.scrollHeight - this.transitionContainer.scrollTop;
    }
  ...
  DayPicker.getFocusedDay = function getFocusedDay(newMonth, props) {
...
(0, _reactLifecyclesCompat.polyfill)(DayPicker);
