...
function (_ref) {
  ...
  function DayPickerKeyboardShortcuts() {
    ...
    _this.state = {
      keyboardShortcuts: getKeyboardShortcuts(phrases)
    };
  ...
  DayPickerKeyboardShortcuts.getDerivedStateFromProps = function getDerivedStateFromProps(props, state) {
  ...
  _proto.render = function render() {
    ...
    var keyboardShortcuts = this.state.keyboardShortcuts;
...
(0, _reactLifecyclesCompat.polyfill)(DayPickerKeyboardShortcuts);
