...
function (_ref) {
  ...
  CalendarMonthGrid.getDerivedStateFromProps = function getDerivedStateFromProps(props, state) {
    var _this2 = this;

    var initialMonth = props.initialMonth,
        numberOfMonths = props.numberOfMonths,
        orientation = props.orientation;
    var prevInitialMonth = state.initialMonth,
    ...
    if (locale !== momentLocale) {
      newState.locale = momentLocale;
      newState.months = newMonths.map(function (m) {
  ...
  _proto.componentDidUpdate = function componentDidUpdate() {
    var _this$props = this.props,
        ...
        onMonthTransitionEnd = _this$props.onMonthTransitionEnd; // For IE9, immediately call onMonthTransitionEnd instead of
...
(0, _reactLifecyclesCompat.polyfill)(CalendarMonthGrid);
