...
function (_ref) {
  ...
  CalendarMonth.getDerivedStateFromProps = function getDerivedStateFromProps(props, state) {
    ...
    var prevMonth = state.month,
        ...
        prevFirstDayOfWeek = state.firstDayOfWeek;
...
(0, _reactLifecyclesCompat.polyfill)(CalendarMonth);
